...
empolyeeObj = Employee(
    id=1, name='hari',
    salary=10000)  #Input should be greater than or equal to 10000
print(empolyeeObj)
...
)  #{'price': 12.0, 'quantity': 12, 'total_price': 144.0} add the compute and to obj instance
